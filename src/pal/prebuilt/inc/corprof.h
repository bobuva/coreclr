 ...
 */
/* Compiler settings for C:/src/dotnet/coreclr/src/inc/corprof.idl:
...
EXTERN_C const IID IID_ICorProfilerInfo10;
    ...
    MIDL_INTERFACE("0C85B4CF-B14B-4F06-99E7-0ECB1DF85ECC")
    ICorProfilerInfo10 : public ICorProfilerInfo9
    {
    public:
        virtual HRESULT STDMETHODCALLTYPE AddAssemblyPath( 
            AppDomainID appDomainId,
            const WCHAR *pAssemblyPath) = 0;
    ...
    typedef struct ICorProfilerInfo10Vtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *AddAssemblyPath )( 
            ICorProfilerInfo10 * This,
            AppDomainID appDomainId,
...
#define ICorProfilerInfo10_AddAssemblyPath(This,appDomainId,pAssemblyPath)	\
    ( (This)->lpVtbl -> AddAssemblyPath(This,appDomainId,pAssemblyPath) ) 
